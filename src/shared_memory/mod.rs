...
impl SharedMemorySystem {
    ...
    pub async fn update_context(
        ...
        // Actualizar en cache
        self.active_contexts.insert(agent_id.clone(), context.clone());
...
mod tests {
    ...
    async fn test_context_creation() {
        ...
        let context = system.get_or_create_context(agent_id.clone()).await.unwrap();
